...
from app.problem_authoring import PROBLEM_TEMPLATE, parse_problem_collection, validate_problem_collection
...
def valid_sum_problem(problem_id: str = "adv_sum_values") -> dict[str, Any]:
    ...
    problem["statement"] = "Return the sum of `nums`."
...
def problem_group_anagrams_order_variant(problem_id: str = "adv_group_anagrams") -> dict[str, Any]:
    ...
    problem["statement"] = "Group words that are anagrams. The group order does not matter."
